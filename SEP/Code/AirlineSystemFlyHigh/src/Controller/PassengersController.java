...
//        sortedList.comparatorProperty().bind(passengerTable.comparatorProperty());
//        passengerTable.setItems(sortedList);
//    }
//
...
//        ObservableList<Passenger> allPassengers= passengers.getPassengers();
//        ObservableList<Passenger> selected= passengerTable.getSelectionModel().getSelectedItems();
//        selected.forEach(allPassengers::remove);
//        makeFilteredList(allPassengers);
//        passengers.setPassengers(allPassengers);
//
//    }
//
...
//        loader.setLocation(getClass().getResource("../View/FXML/Administrator/EditPassengerForm.fxml"));
//        loader.load();
//        EditPassengerFormnController controller = loader.getController();
